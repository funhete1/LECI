...
public class Ex5 {
    ...
    public static String getInput()throws ValueOutOfBounds{
        ...
        if(!(Integer.parseInt(date[0]) > 0 && Integer.parseInt(date[0]) < 8)) throw  new ValueOutOfBounds("Value must be between 1 and 7"); //try keep the value once u gonna use to many times 
                                                                                                                                                        //use switch case.
                                                                                                //https://www.includehelp.com/java-programs/find-the-number-of-days-in-a-month-using-a-switch-statement.aspx
